...
public class ShoppingCartActivity extends BaseActvity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acticity_shopping_cart);
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<Item, ItemViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Item, ItemViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ItemViewHolder holder, int position, @NonNull final Item model) {
                ...
                Glide.with(ShoppingCartActivity.this).load(model.getImage()).placeholder(R.drawable.default_item_image).into(holder.item_image);
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ShoppingCartActivity.this, ItemInformationActivity.class);
...
//                }
                        ...
                        deleteDialog = new DeleteDialog(ShoppingCartActivity.this,params);
                        ...
                        deleteDialog.setYesOnclickListener("YES", new DeleteDialog.onYesOnclickListener() {
                            ...
                            public void onYesClick() {
                                ...
                                Toast.makeText(ShoppingCartActivity.this, "Deleted ", Toast.LENGTH_SHORT).show();
                                //Remove swiped item from list and notify the RecyclerView
                                final int position = viewHolder.getAdapterPosition();
...
//    }
    ...
    private void initView() {
        ...
        mCartList = this.findViewById(R.id.cart_items);
